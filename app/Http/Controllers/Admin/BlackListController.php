...
class BlackListController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = BlackList::select()->orderby('id', 'DESC')->paginate(10);
     ...
     */
    public function update(BlackListRequest $request, string $id)
    {
         check_permission_sub_menue_actions_redirect(7);
        try {
            $data = BlackList::select()->find($id);
            ...
            BlackList::where(['id' => $id])->update($data_to_update);
