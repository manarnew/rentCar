...
class CustomerController extends Controller
{
 ...
 public function updateImage($requestImage,$dataImage,$request){
    ...
    public function send($id)
    {
        ...
        $route = route('admin.customer.ajax_search_genral_get', $id_get);
        
        // Ensure you have a valid access token
        $access_token = '657747e37e629'; // Replace with a valid access token
        $url = "https://waclient.com/api/send?number={$item_row->phone}&type=text&message=$route&instance_id=665C1BA489230&access_token=$access_token";
