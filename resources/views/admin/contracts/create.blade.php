...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center"> اضافة حجز جديد</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('contracts.store') }}" method="post">
                @csrf
                <div class="row">
                    <input type="hidden" name="car_id" id="car_id" class="form-control" value="{{ $car_id->id }}">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label> نوع الحجز</label>
                            <select id="contract_type" name="contract_type" class="form-control ">
                                <option value=""> اختر نوع الحجز </option>
                                <option @if (old('contract_type') == 1) selected="selected" @endif value="1"> يومي
                                </option>
                                <option @if (old('contract_type') == 2) selected="selected" @endif value="2"> اسبوعي
                                </option>
                                <option @if (old('contract_type') == 3) selected="selected" @endif value="3"> شهري
                                </option>
                            </select>
                            @error('contract_type')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="contract_status" name="contract_status" class="form-control ">
                                ...
                                <option @if (old('contract_status') == 1) selected="selected" @endif value="1"> مكتمل
                                </option>
                                <option @if (old('contract_status') == 2) selected="selected" @endif value="2"> في
                                    الانتظار </option>
                                <option @if (old('contract_status') == 3) selected="selected" @endif value="3"> مرفوض
                                </option>
                                <option @if (old('contract_status') == 4) selected="selected" @endif value="4"> ملغي
                                </option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="exist_date" id="exist_date" class="form-control"
                                value="{{ old('exist_date', date('Y-m-d')) }}">
                            @error('exist_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input readonly type="number" name="excess_km_price" id="excess_km_price"
                                class="form-control" value="{{ old('excess_km_price') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
