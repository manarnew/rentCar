...
<div class="row">
   <div class="col-12">
    ...
    <a style="background-color: #DC3545;" href="{{ route('admin.permission_roles.delete_permission_sub_menues_actions',$action->id) }}" class="btn btn-sm are_you_shue text-light">{{ $action->permission_sub_menues_actions_name }} <i class="fa fa-trash" aria-hidden="true"></i></a>
